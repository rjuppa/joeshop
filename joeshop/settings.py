...
LOGIN_URL = '/vitashop/login/'
LOGOUT_URL = '/vitashop/logout/'
LOGIN_REDIRECT_URL = '/'

SOCIAL_AUTH_LOGIN_REDIRECT_URL = '/vitashop/profile/'
SOCIAL_AUTH_LOGIN_ERROR_URL = '/login-error/'
SOCIAL_AUTH_NEW_USER_REDIRECT_URL = '/vitashop/profile/'
SOCIAL_AUTH_NEW_ASSOCIATION_REDIRECT_URL = '/vitashop/profile/'
